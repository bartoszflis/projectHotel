...
<form:form modelAttribute="guest" method="POST" class="form-horizontal">
    <div class="form-group">
        <div class="col-sm-4">
            First name:<form:input path="firstName" class="form-control col-lg-5"/><br/>
        </div>
        <div class="col-sm-4">
            <label for="2"> Last name:</label> <form:input  path="lastName" id="2" class="form-control col-lg-5"/><br/>
        </div>
        <div class="col-sm-4">
            <label for="3"> Email:</label> <form:input  path="Email" id="3" class="form-control col-lg-5"/><br/>
        </div>
